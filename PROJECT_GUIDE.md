...
> 最后更新：2026-05-22 15:57 | 工作空间：`/Users/mindy/CodeBuddy/20260521173149/cat-learning`
> GitHub: `git@github.com:mindywang19871129/cat-learning.git`
>
> **变更记录**：见 Git 提交历史。每次变更同步更新本文档。
>
> **当前部署状态**：代码 v2.6 | DeepSeek ✅ | 飞书 ✅ | OCR.space ✅ | 家长密码 ✅ | 📚联网搜教材 | 🔬错题本分析 | 🎯飞书动态调整 | 📖 KET备考体系(v2.6) | 🎉 全链路就绪
...
| 功能 | 触发方式 | 说明 |
|------|---------|------|
| 📝 **每日出题** | 自动(09:00) 或 `POST /push` | 数学4题(按7单元范围) + KET英语4题(按备考阶段，读写听说35/15/25/25) |
