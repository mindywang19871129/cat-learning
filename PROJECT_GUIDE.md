...
> 最后更新：2026-05-22 14:43 | 工作空间：`/Users/mindy/CodeBuddy/20260521173149/cat-learning`
> GitHub: `git@github.com:mindywang19871129/cat-learning.git`
>
> **变更记录**：见 Git 提交历史。每次变更同步更新本文档。
>
> **当前部署状态**：代码 v2.3 | DeepSeek ✅ | 飞书 ✅ | OCR.space ✅ | 家长密码 ✅ | 📚教材/年级变更 | 🎉 全链路就绪
...
| 📚 **更换教材** | 飞书发"更换教材为人教版四下" | 需密码验证，然后上传教材目录文件 |
| 🎓 **调整年级** | 飞书发"调整年级为四年级" | 需密码验证，自动重置知识体系 |
...
| 📚 **教材智能识别** | 上传教材目录文件→自动提取知识体系→更新题库范围 |
...
**方式C：通过飞书指令换教材/年级（v2.3新增）**

```bash
# 1. 在飞书给机器人发（需密码验证）
"更换教材为人教版四年级下册 密码631789"

# 2. 系统回复要求上传教材目录，拍照或发PDF
# 3. 上传教材目录文件后，系统自动提取知识体系、重置掌握度
# 4. 次日开始按新教材出题
```
